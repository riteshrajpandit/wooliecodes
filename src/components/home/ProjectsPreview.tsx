      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="mb-16 text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            <span className="handwritten text-[color:var(--color-primary)]">Chapter 2:</span> Featured Projects
          </h2>
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Link 
                    ...
                    className="flex items-center text-[color:var(--color-primary)] hover:text-[color:var(--color-primary)] hover:underline font-medium"
                  >
